import"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const Af=()=>{};var cc={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Us="[DEFAULT]",Qp={[Ms]:"fire-core",[wp]:"fire-core-compat",[bp]:"fire-analytics",[Ip]:"fire-analytics-compat",[Rp]:"fire-app-check",[Ap]:"fire-app-check-compat",[Cp]:"fire-auth",[Sp]:"fire-auth-compat",[Pp]:"fire-rtdb",[kp]:"fire-data-connect",[Dp]:"fire-rtdb-compat",[xp]:"fire-fn",[Np]:"fire-fn-compat",[Op]:"fire-iid",[Vp]:"fire-iid-compat",[Lp]:"fire-fcm",[Mp]:"fire-fcm-compat",[Up]:"fire-perf",[Fp]:"fire-perf-compat",[Bp]:"fire-rc",[$p]:"fire-rc-compat",[jp]:"fire-gcs",[qp]:"fire-gcs-compat",[Hp]:"fire-fst",[Gp]:"fire-fst-compat",[zp]:"fire-vertex","fire-js":"fire-js",[Wp]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Om({appConfig:n,heartbeatServiceProvider:e},t){const r=Vm(n,t),i=gm(n,t),s=e.getImmediate({optional:!0});if(s){const d=await s.getHeartbeatsHeader();d&&i.append("x-firebase-client",d)}const a={installation:{sdkVersion:lu,appId:n.appId}},c={method:"POST",headers:i,body:JSON.stringify(a)},u=await gu(()=>fetch(r,c));if(u.ok){const d=await u.json();return fu(d)}else throw await pu("Generate Auth Token",u)}function Vm(n,{fid:e}){return`${du(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ui(n){var e;const t=n.auth,r=await n.getIdToken(),i=await dn(n,li(t,{idToken:r}));U(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const a=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?Vu(s.providerUserInfo):[],c=Wg(n.providerData,a),u=n.isAnonymous,d=!(n.email&&s.passwordHash)&&!(c!=null&&c.length),p=u?d:!1,m={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:c,metadata:new js(s.createdAt,s.lastLoginAt),isAnonymous:p};Object.assign(n,m)}async function Gg(n){const e=Ie(n);await ui(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Wg(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function Vu(n){return n.map(e=>{var{providerId:t}=e,r=_o(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lu{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Lu.type="NONE";const xc=Lu;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yr(n,e,t){return`firebase:${n}:${e}:${t}`}class cn{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=Yr(this.userKey,i.apiKey,s),this.fullPersistenceKey=Yr("persistence",i.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await li(this.auth,{idToken:e}).catch(()=>{});return t?Ve._fromGetAccountInfoResponse(this.auth,t,e):null}return Ve._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new cn(et(xc),e,r);const i=(await Promise.all(t.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let s=i[0]||et(xc);const a=Yr(r,e.config.apiKey,e.name);let c=null;for(const d of t)try{const p=await d._get(a);if(p){let m;if(typeof p=="string"){const v=await li(e,{idToken:p}).catch(()=>{});if(!v)break;m=await Ve._fromGetAccountInfoResponse(e,v,p)}else m=Ve._fromJSON(e,p);d!==s&&(c=m),s=d;break}}catch{}const u=i.filter(d=>d._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new cn(s,e,r):(s=u[0],c&&await s._set(a,c.toJSON()),await Promise.all(t.map(async d=>{if(d!==s)try{await d._remove(a)}catch{}})),new cn(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ey(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function wy(n){const e=zn(Gn(n)).link,t=e?zn(Gn(e)).deep_link_id:null,r=zn(Gn(n)).deep_link_id;return(r?zn(Gn(r)).link:null)||r||t||e||n}class bo{constructor(e){var t,r,i,s,a,c;const u=zn(Gn(e)),d=(t=u.apiKey)!==null&&t!==void 0?t:null,p=(r=u.oobCode)!==null&&r!==void 0?r:null,m=Ey((i=u.mode)!==null&&i!==void 0?i:null);U(d&&p&&m,"argument-error"),this.apiKey=d,this.operation=m,this.code=p,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(a=u.lang)!==null&&a!==void 0?a:null,this.tenantId=(c=u.tenantId)!==null&&c!==void 0?c:null}static parseLink(e){const t=wy(e);try{return new bo(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V_="__/auth/handler",L_="emulator/auth/handler",M_=encodeURIComponent("fac");async function qc(n,e,t,r,i,s){U(n.config.authDomain,n,"auth-domain-config-required"),U(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:Tn,eventId:i};if(e instanceof Qu){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",Kf(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[p,m]of Object.entries({}))a[p]=m}if(e instanceof gr){const p=e.getScopes().filter(m=>m!=="");p.length>0&&(a.scopes=p.join(","))}n.tenantId&&(a.tid=n.tenantId);const c=a;for(const p of Object.keys(c))c[p]===void 0&&delete c[p];const u=await n._getAppCheckToken(),d=u?`#${M_}=${encodeURIComponent(u)}`:"";return`${U_(n)}?${pr(c).slice(1)}${d}`}function U_({config:n}){return n.emulator?To(n,L_):`https://${n.authDomain}/${V_}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Tt,lh;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(E,g){function _(){}_.prototype=g.prototype,E.D=g.prototype,E.prototype=new _,E.prototype.constructor=E,E.C=function(T,w,b){for(var y=Array(arguments.length-2),Ye=2;Ye<arguments.length;Ye++)y[Ye-2]=arguments[Ye];return g.prototype[w].apply(T,y)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(E,g,_){_||(_=0);var T=Array(16);if(typeof g=="string")for(var w=0;16>w;++w)T[w]=g.charCodeAt(_++)|g.charCodeAt(_++)<<8|g.charCodeAt(_++)<<16|g.charCodeAt(_++)<<24;else for(w=0;16>w;++w)T[w]=g[_++]|g[_++]<<8|g[_++]<<16|g[_++]<<24;g=E.g[0],_=E.g[1],w=E.g[2];var b=E.g[3],y=g+(b^_&(w^b))+T[0]+3614090360&4294967295;g=_+(y<<7&4294967295|y>>>25),y=b+(w^g&(_^w))+T[1]+3905402710&4294967295,b=g+(y<<12&4294967295|y>>>20),y=w+(_^b&(g^_))+T[2]+606105819&4294967295,w=b+(y<<17&4294967295|y>>>15),y=_+(g^w&(b^g))+T[3]+3250441966&4294967295,_=w+(y<<22&4294967295|y>>>10),y=g+(b^_&(w^b))+T[4]+4118548399&4294967295,g=_+(y<<7&4294967295|y>>>25),y=b+(w^g&(_^w))+T[5]+1200080426&4294967295,b=g+(y<<12&4294967295|y>>>20),y=w+(_^b&(g^_))+T[6]+2821735955&4294967295,w=b+(y<<17&4294967295|y>>>15),y=_+(g^w&(b^g))+T[7]+4249261313&4294967295,_=w+(y<<22&4294967295|y>>>10),y=g+(b^_&(w^b))+T[8]+1770035416&4294967295,g=_+(y<<7&4294967295|y>>>25),y=b+(w^g&(_^w))+T[9]+2336552879&4294967295,b=g+(y<<12&4294967295|y>>>20),y=w+(_^b&(g^_))+T[10]+4294925233&4294967295,w=b+(y<<17&4294967295|y>>>15),y=_+(g^w&(b^g))+T[11]+2304563134&4294967295,_=w+(y<<22&4294967295|y>>>10),y=g+(b^_&(w^b))+T[12]+1804603682&4294967295,g=_+(y<<7&4294967295|y>>>25),y=b+(w^g&(_^w))+T[13]+4254626195&4294967295,b=g+(y<<12&4294967295|y>>>20),y=w+(_^b&(g^_))+T[14]+2792965006&4294967295,w=b+(y<<17&4294967295|y>>>15),y=_+(g^w&(b^g))+T[15]+1236535329&4294967295,_=w+(y<<22&4294967295|y>>>10),y=g+(w^b&(_^w))+T[1]+4129170786&4294967295,g=_+(y<<5&4294967295|y>>>27),y=b+(_^w&(g^_))+T[6]+3225465664&4294967295,b=g+(y<<9&4294967295|y>>>23),y=w+(g^_&(b^g))+T[11]+643717713&4294967295,w=b+(y<<14&4294967295|y>>>18),y=_+(b^g&(w^b))+T[0]+3921069994&4294967295,_=w+(y<<20&4294967295|y>>>12),y=g+(w^b&(_^w))+T[5]+3593408605&4294967295,g=_+(y<<5&4294967295|y>>>27),y=b+(_^w&(g^_))+T[10]+38016083&4294967295,b=g+(y<<9&4294967295|y>>>23),y=w+(g^_&(b^g))+T[15]+3634488961&4294967295,w=b+(y<<14&4294967295|y>>>18),y=_+(b^g&(w^b))+T[4]+3889429448&4294967295,_=w+(y<<20&4294967295|y>>>12),y=g+(w^b&(_^w))+T[9]+568446438&4294967295,g=_+(y<<5&4294967295|y>>>27),y=b+(_^w&(g^_))+T[14]+3275163606&4294967295,b=g+(y<<9&4294967295|y>>>23),y=w+(g^_&(b^g))+T[3]+4107603335&4294967295,w=b+(y<<14&4294967295|y>>>18),y=_+(b^g&(w^b))+T[8]+1163531501&4294967295,_=w+(y<<20&4294967295|y>>>12),y=g+(w^b&(_^w))+T[13]+2850285829&4294967295,g=_+(y<<5&4294967295|y>>>27),y=b+(_^w&(g^_))+T[2]+4243563512&4294967295,b=g+(y<<9&4294967295|y>>>23),y=w+(g^_&(b^g))+T[7]+1735328473&4294967295,w=b+(y<<14&4294967295|y>>>18),y=_+(b^g&(w^b))+T[12]+2368359562&4294967295,_=w+(y<<20&4294967295|y>>>12),y=g+(_^w^b)+T[5]+4294588738&4294967295,g=_+(y<<4&4294967295|y>>>28),y=b+(g^_^w)+T[8]+2272392833&4294967295,b=g+(y<<11&4294967295|y>>>21),y=w+(b^g^_)+T[11]+1839030562&4294967295,w=b+(y<<16&4294967295|y>>>16),y=_+(w^b^g)+T[14]+4259657740&4294967295,_=w+(y<<23&4294967295|y>>>9),y=g+(_^w^b)+T[1]+2763975236&4294967295,g=_+(y<<4&4294967295|y>>>28),y=b+(g^_^w)+T[4]+1272893353&4294967295,b=g+(y<<11&4294967295|y>>>21),y=w+(b^g^_)+T[7]+4139469664&4294967295,w=b+(y<<16&4294967295|y>>>16),y=_+(w^b^g)+T[10]+3200236656&4294967295,_=w+(y<<23&4294967295|y>>>9),y=g+(_^w^b)+T[13]+681279174&4294967295,g=_+(y<<4&4294967295|y>>>28),y=b+(g^_^w)+T[0]+3936430074&4294967295,b=g+(y<<11&4294967295|y>>>21),y=w+(b^g^_)+T[3]+3572445317&4294967295,w=b+(y<<16&4294967295|y>>>16),y=_+(w^b^g)+T[6]+76029189&4294967295,_=w+(y<<23&4294967295|y>>>9),y=g+(_^w^b)+T[9]+3654602809&4294967295,g=_+(y<<4&4294967295|y>>>28),y=b+(g^_^w)+T[12]+3873151461&4294967295,b=g+(y<<11&4294967295|y>>>21),y=w+(b^g^_)+T[15]+530742520&4294967295,w=b+(y<<16&4294967295|y>>>16),y=_+(w^b^g)+T[2]+3299628645&4294967295,_=w+(y<<23&4294967295|y>>>9),y=g+(w^(_|~b))+T[0]+4096336452&4294967295,g=_+(y<<6&4294967295|y>>>26),y=b+(_^(g|~w))+T[7]+1126891415&4294967295,b=g+(y<<10&4294967295|y>>>22),y=w+(g^(b|~_))+T[14]+2878612391&4294967295,w=b+(y<<15&4294967295|y>>>17),y=_+(b^(w|~g))+T[5]+4237533241&4294967295,_=w+(y<<21&4294967295|y>>>11),y=g+(w^(_|~b))+T[12]+1700485571&4294967295,g=_+(y<<6&4294967295|y>>>26),y=b+(_^(g|~w))+T[3]+2399980690&4294967295,b=g+(y<<10&4294967295|y>>>22),y=w+(g^(b|~_))+T[10]+4293915773&4294967295,w=b+(y<<15&4294967295|y>>>17),y=_+(b^(w|~g))+T[1]+2240044497&4294967295,_=w+(y<<21&4294967295|y>>>11),y=g+(w^(_|~b))+T[8]+1873313359&4294967295,g=_+(y<<6&4294967295|y>>>26),y=b+(_^(g|~w))+T[15]+4264355552&4294967295,b=g+(y<<10&4294967295|y>>>22),y=w+(g^(b|~_))+T[6]+2734768916&4294967295,w=b+(y<<15&4294967295|y>>>17),y=_+(b^(w|~g))+T[13]+1309151649&4294967295,_=w+(y<<21&4294967295|y>>>11),y=g+(w^(_|~b))+T[4]+4149444226&4294967295,g=_+(y<<6&4294967295|y>>>26),y=b+(_^(g|~w))+T[11]+3174756917&4294967295,b=g+(y<<10&4294967295|y>>>22),y=w+(g^(b|~_))+T[2]+718787259&4294967295,w=b+(y<<15&4294967295|y>>>17),y=_+(b^(w|~g))+T[9]+3951481745&4294967295,E.g[0]=E.g[0]+g&4294967295,E.g[1]=E.g[1]+(w+(y<<21&4294967295|y>>>11))&4294967295,E.g[2]=E.g[2]+w&4294967295,E.g[3]=E.g[3]+b&4294967295}r.prototype.u=function(E,g){g===void 0&&(g=E.length);for(var _=g-this.blockSize,T=this.B,w=this.h,b=0;b<g;){if(w==0)for(;b<=_;)i(this,E,b),b+=this.blockSize;if(typeof E=="string"){for(;b<g;)if(T[w++]=E.charCodeAt(b++),w==this.blockSize){i(this,T),w=0;break}}else for(;b<g;)if(T[w++]=E[b++],w==this.blockSize){i(this,T),w=0;break}}this.h=w,this.o+=g},r.prototype.v=function(){var E=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);E[0]=128;for(var g=1;g<E.length-8;++g)E[g]=0;var _=8*this.o;for(g=E.length-8;g<E.length;++g)E[g]=_&255,_/=256;for(this.u(E),E=Array(16),g=_=0;4>g;++g)for(var T=0;32>T;T+=8)E[_++]=this.g[g]>>>T&255;return E};function s(E,g){var _=c;return Object.prototype.hasOwnProperty.call(_,E)?_[E]:_[E]=g(E)}function a(E,g){this.h=g;for(var _=[],T=!0,w=E.length-1;0<=w;w--){var b=E[w]|0;T&&b==g||(_[w]=b,T=!1)}this.g=_}var c={};function u(E){return-128<=E&&128>E?s(E,function(g){return new a([g|0],0>g?-1:0)}):new a([E|0],0>E?-1:0)}function d(E){if(isNaN(E)||!isFinite(E))return m;if(0>E)return P(d(-E));for(var g=[],_=1,T=0;E>=_;T++)g[T]=E/_|0,_*=4294967296;return new a(g,0)}function p(E,g){if(E.length==0)throw Error("number format error: empty string");if(g=g||10,2>g||36<g)throw Error("radix out of range: "+g);if(E.charAt(0)=="-")return P(p(E.substring(1),g));if(0<=E.indexOf("-"))throw Error('number format error: interior "-" character');for(var _=d(Math.pow(g,8)),T=m,w=0;w<E.length;w+=8){var b=Math.min(8,E.length-w),y=parseInt(E.substring(w,w+b),g);8>b?(b=d(Math.pow(g,b)),T=T.j(b).add(d(y))):(T=T.j(_),T=T.add(d(y)))}return T}var m=u(0),v=u(1),R=u(16777216);n=a.prototype,n.m=function(){if(D(this))return-P(this).m();for(var E=0,g=1,_=0;_<this.g.length;_++){var T=this.i(_);E+=(0<=T?T:4294967296+T)*g,g*=4294967296}return E},n.toString=function(E){if(E=E||10,2>E||36<E)throw Error("radix out of range: "+E);if(C(this))return"0";if(D(this))return"-"+P(this).toString(E);for(var g=d(Math.pow(E,6)),_=this,T="";;){var w=K(_,g).g;_=j(_,w.j(g));var b=((0<_.g.length?_.g[0]:_.h)>>>0).toString(E);if(_=w,C(_))return b+T;for(;6>b.length;)b="0"+b;T=b+T}},n.i=function(E){return 0>E?0:E<this.g.length?this.g[E]:this.h};function C(E){if(E.h!=0)return!1;for(var g=0;g<E.g.length;g++)if(E.g[g]!=0)return!1;return!0}function D(E){return E.h==-1}n.l=function(E){return E=j(this,E),D(E)?-1:C(E)?0:1};function P(E){for(var g=E.g.length,_=[],T=0;T<g;T++)_[T]=~E.g[T];return new a(_,~E.h).add(v)}n.abs=function(){return D(this)?P(this):this},n.add=function(E){for(var g=Math.max(this.g.length,E.g.length),_=[],T=0,w=0;w<=g;w++){var b=T+(this.i(w)&65535)+(E.i(w)&65535),y=(b>>>16)+(this.i(w)>>>16)+(E.i(w)>>>16);T=y>>>16,b&=65535,y&=65535,_[w]=y<<16|b}return new a(_,_[_.length-1]&-2147483648?-1:0)};function j(E,g){return E.add(P(g))}n.j=function(E){if(C(this)||C(E))return m;if(D(this))return D(E)?P(this).j(P(E)):P(P(this).j(E));if(D(E))return P(this.j(P(E)));if(0>this.l(R)&&0>E.l(R))return d(this.m()*E.m());for(var g=this.g.length+E.g.length,_=[],T=0;T<2*g;T++)_[T]=0;for(T=0;T<this.g.length;T++)for(var w=0;w<E.g.length;w++){var b=this.i(T)>>>16,y=this.i(T)&65535,Ye=E.i(w)>>>16,Cn=E.i(w)&65535;_[2*T+2*w]+=y*Cn,O(_,2*T+2*w),_[2*T+2*w+1]+=b*Cn,O(_,2*T+2*w+1),_[2*T+2*w+1]+=y*Ye,O(_,2*T+2*w+1),_[2*T+2*w+2]+=b*Ye,O(_,2*T+2*w+2)}for(T=0;T<g;T++)_[T]=_[2*T+1]<<16|_[2*T];for(T=g;T<2*g;T++)_[T]=0;return new a(_,0)};function O(E,g){for(;(E[g]&65535)!=E[g];)E[g+1]+=E[g]>>>16,E[g]&=65535,g++}function V(E,g){this.g=E,this.h=g}function K(E,g){if(C(g))throw Error("division by zero");if(C(E))return new V(m,m);if(D(E))return g=K(P(E),g),new V(P(g.g),P(g.h));if(D(g))return g=K(E,P(g)),new V(P(g.g),g.h);if(30<E.g.length){if(D(E)||D(g))throw Error("slowDivide_ only works with positive integers.");for(var _=v,T=g;0>=T.l(E);)_=ce(_),T=ce(T);var w=X(_,1),b=X(T,1);for(T=X(T,2),_=X(_,2);!C(T);){var y=b.add(T);0>=y.l(E)&&(w=w.add(_),b=y),T=X(T,1),_=X(_,1)}return g=j(E,w.j(g)),new V(w,g)}for(w=m;0<=E.l(g);){for(_=Math.max(1,Math.floor(E.m()/g.m())),T=Math.ceil(Math.log(_)/Math.LN2),T=48>=T?1:Math.pow(2,T-48),b=d(_),y=b.j(g);D(y)||0<y.l(E);)_-=T,b=d(_),y=b.j(g);C(b)&&(b=v),w=w.add(b),E=j(E,y)}return new V(w,E)}n.A=function(E){return K(this,E).h},n.and=function(E){for(var g=Math.max(this.g.length,E.g.length),_=[],T=0;T<g;T++)_[T]=this.i(T)&E.i(T);return new a(_,this.h&E.h)},n.or=function(E){for(var g=Math.max(this.g.length,E.g.length),_=[],T=0;T<g;T++)_[T]=this.i(T)|E.i(T);return new a(_,this.h|E.h)},n.xor=function(E){for(var g=Math.max(this.g.length,E.g.length),_=[],T=0;T<g;T++)_[T]=this.i(T)^E.i(T);return new a(_,this.h^E.h)};function ce(E){for(var g=E.g.length+1,_=[],T=0;T<g;T++)_[T]=E.i(T)<<1|E.i(T-1)>>>31;return new a(_,E.h)}function X(E,g){var _=g>>5;g%=32;for(var T=E.g.length-_,w=[],b=0;b<T;b++)w[b]=0<g?E.i(b+_)>>>g|E.i(b+_+1)<<32-g:E.i(b+_);return new a(w,E.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,lh=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=p,Tt=a}).apply(typeof Wc<"u"?Wc:typeof self<"u"?self:typeof window<"u"?window:{});var jr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const So=-1;function Li(n){return n==null}function pi(n){return n===0&&1/n==-1/0}function uv(n){return typeof n=="number"&&Number.isInteger(n)&&!pi(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Le{constructor(e){this.fields=e,e.sort(de.comparator)}static empty(){return new Le([])}unionWith(e){let t=new ae(de.comparator);for(const r of this.fields)t=t.add(r);for(const r of e)t=t.add(r);return new Le(t.toArray())}covers(e){for(const t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return pn(this.fields,e.fields,(t,r)=>t.isEqual(r))}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nv=new Z(M.comparator);function st(){return Nv}const Mh=new Z(M.comparator);function Kn(...n){let e=Mh;for(const t of n)e=e.insert(t.key,t);return e}function Uh(n){let e=Mh;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Ut(){return tr()}function Fh(){return tr()}function tr(){return new Wt(n=>n.toString(),(n,e)=>n.isEqual(e))}const Ov=new Z(M.comparator),Vv=new ae(M.comparator);function z(...n){let e=Vv;for(const t of n)e=e.add(t);return e}const Lv=new ae(q);function Mv(){return Lv}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RT{constructor(e,t,r,i){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=i}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(i=>(r=i,this.remoteDocumentCache.getEntry(e,t))).next(i=>(r!==null&&nr(r.mutation,i,Le.empty(),se.now()),i))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,z()).next(()=>r))}getLocalViewOfDocuments(e,t,r=z()){const i=Ut();return this.populateOverlays(e,i,t).next(()=>this.computeViews(e,t,i,r).next(s=>{let a=Kn();return s.forEach((c,u)=>{a=a.insert(c,u.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const r=Ut();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,z()))}populateOverlays(e,t,r){const i=[];return r.forEach(s=>{t.has(s)||i.push(s)}),this.documentOverlayCache.getOverlays(e,i).next(s=>{s.forEach((a,c)=>{t.set(a,c)})})}computeViews(e,t,r,i){let s=st();const a=tr(),c=function(){return tr()}();return t.forEach((u,d)=>{const p=r.get(d.key);i.has(d.key)&&(p===void 0||p.mutation instanceof Kt)?s=s.insert(d.key,d):p!==void 0?(a.set(d.key,p.mutation.getFieldMask()),nr(p.mutation,d,p.mutation.getFieldMask(),se.now())):a.set(d.key,Le.empty())}),this.recalculateAndSaveOverlays(e,s).next(u=>(u.forEach((d,p)=>a.set(d,p)),t.forEach((d,p)=>{var m;return c.set(d,new AT(p,(m=a.get(d))!==null&&m!==void 0?m:null))}),c))}recalculateAndSaveOverlays(e,t){const r=tr();let i=new Z((a,c)=>a-c),s=z();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const c of a)c.keys().forEach(u=>{const d=t.get(u);if(d===null)return;let p=r.get(u)||Le.empty();p=c.applyToLocalView(d,p),r.set(u,p);const m=(i.get(c.batchId)||z()).add(u);i=i.insert(c.batchId,m)})}).next(()=>{const a=[],c=i.getReverseIterator();for(;c.hasNext();){const u=c.getNext(),d=u.key,p=u.value,m=Fh();p.forEach(v=>{if(!s.has(v)){const R=zh(t.get(v),r.get(v));R!==null&&m.set(v,R),s=s.add(v)}}),a.push(this.documentOverlayCache.saveOverlays(e,d,m))}return S.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,i){return function(a){return M.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Pv(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,i):this.getDocumentsMatchingCollectionQuery(e,t,r,i)}getNextDocuments(e,t,r,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,i).next(s=>{const a=i-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,i-s.size):S.resolve(Ut());let c=sr,u=s;return a.next(d=>S.forEach(d,(p,m)=>(c<m.largestBatchId&&(c=m.largestBatchId),s.get(p)?S.resolve():this.remoteDocumentCache.getEntry(e,p).next(v=>{u=u.insert(p,v)}))).next(()=>this.populateOverlays(e,d,s)).next(()=>this.computeViews(e,u,d,z())).next(p=>({batchId:c,changes:Uh(p)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new M(t)).next(r=>{let i=Kn();return r.isFoundDocument()&&(i=i.insert(r.key,r)),i})}getDocumentsMatchingCollectionGroupQuery(e,t,r,i){const s=t.collectionGroup;let a=Kn();return this.indexManager.getCollectionParents(e,s).next(c=>S.forEach(c,u=>{const d=function(m,v){return new Ui(v,null,m.explicitOrderBy.slice(),m.filters.slice(),m.limit,m.limitType,m.startAt,m.endAt)}(t,u.child(s));return this.getDocumentsMatchingCollectionQuery(e,d,r,i).next(p=>{p.forEach((m,v)=>{a=a.insert(m,v)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,r,i){let s;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(a=>(s=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,s,i))).next(a=>{s.forEach((u,d)=>{const p=d.getKey();a.get(p)===null&&(a=a.insert(p,Ee.newInvalidDocument(p)))});let c=Kn();return a.forEach((u,d)=>{const p=s.get(u);p!==void 0&&nr(p.mutation,d,Le.empty(),se.now()),Bi(t,d)&&(c=c.insert(u,d))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LT{constructor(){this.Vs=!1,this.fs=!1,this.gs=100,this.ps=function(){return qf()?8:lv(we())>0?6:4}()}initialize(e,t){this.ys=e,this.indexManager=t,this.Vs=!0}getDocumentsMatchingQuery(e,t,r,i){const s={result:null};return this.ws(e,t).next(a=>{s.result=a}).next(()=>{if(!s.result)return this.Ss(e,t,i,r).next(a=>{s.result=a})}).next(()=>{if(s.result)return;const a=new VT;return this.bs(e,t,a).next(c=>{if(s.result=c,this.fs)return this.Ds(e,t,a,c.size)})}).next(()=>s.result)}Ds(e,t,r,i){return r.documentReadCount<this.gs?(tn()<=H.DEBUG&&N("QueryEngine","SDK will not create cache indexes for query:",nn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.gs,"documents"),S.resolve()):(tn()<=H.DEBUG&&N("QueryEngine","Query:",nn(t),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.ps*i?(tn()<=H.DEBUG&&N("QueryEngine","The SDK decides to create cache indexes for query:",nn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,He(t))):S.resolve())}ws(e,t){if(hl(t))return S.resolve(null);let r=He(t);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(t.limit!==null&&i===1&&(t=Js(t,null,"F"),r=He(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const a=z(...s);return this.ys.getDocuments(e,a).next(c=>this.indexManager.getMinOffset(e,r).next(u=>{const d=this.vs(t,c);return this.Cs(t,d,a,u.readTime)?this.ws(e,Js(t,null,"F")):this.Fs(e,d,t,u)}))})))}Ss(e,t,r,i){return hl(t)||i.isEqual(B.min())?S.resolve(null):this.ys.getDocuments(e,r).next(s=>{const a=this.vs(t,s);return this.Cs(t,a,r,i)?S.resolve(null):(tn()<=H.DEBUG&&N("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),nn(t)),this.Fs(e,a,t,iv(i,sr)).next(c=>c))})}vs(e,t){let r=new ae(Lh(e));return t.forEach((i,s)=>{Bi(e,s)&&(r=r.add(s))}),r}Cs(e,t,r,i){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const s=e.limitType==="F"?t.last():t.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}bs(e,t,r){return tn()<=H.DEBUG&&N("QueryEngine","Using full collection scan to execute query:",nn(t)),this.ys.getDocumentsMatchingQuery(e,t,bt.min(),r)}Fs(e,t,r,i){return this.ys.getDocumentsMatchingQuery(e,r,i).next(s=>(t.forEach(a=>{s=s.insert(a.key,a)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e="WebChannelConnection";class JT extends QT{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,r,i,s){const a=ro();return new Promise((c,u)=>{const d=new uh;d.setWithCredentials(!0),d.listenOnce(hh.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case Zr.NO_ERROR:const m=d.getResponseJson();N(_e,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(m)),c(m);break;case Zr.TIMEOUT:N(_e,`RPC '${e}' ${a} timed out`),u(new L(k.DEADLINE_EXCEEDED,"Request time out"));break;case Zr.HTTP_ERROR:const v=d.getStatus();if(N(_e,`RPC '${e}' ${a} failed with status:`,v,"response text:",d.getResponseText()),v>0){let R=d.getResponseJson();Array.isArray(R)&&(R=R[0]);const C=R==null?void 0:R.error;if(C&&C.status&&C.message){const D=function(j){const O=j.toLowerCase().replace(/_/g,"-");return Object.values(k).indexOf(O)>=0?O:k.UNKNOWN}(C.status);u(new L(D,C.message))}else u(new L(k.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new L(k.UNAVAILABLE,"Connection failed."));break;default:F(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{N(_e,`RPC '${e}' ${a} completed.`)}});const p=JSON.stringify(i);N(_e,`RPC '${e}' ${a} sending request:`,i),d.send(t,"POST",p,r,15)})}T_(e,t,r){const i=ro(),s=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=ph(),c=fh(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Ho(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const p=s.join("");N(_e,`Creating RPC '${e}' stream ${i}: ${p}`,u);const m=a.createWebChannel(p,u);let v=!1,R=!1;const C=new YT({Zo:P=>{R?N(_e,`Not sending because RPC '${e}' stream ${i} is closed:`,P):(v||(N(_e,`Opening RPC '${e}' stream ${i} transport.`),m.open(),v=!0),N(_e,`RPC '${e}' stream ${i} sending:`,P),m.send(P))},Xo:()=>m.close()}),D=(P,j,O)=>{P.listen(j,V=>{try{O(V)}catch(K){setTimeout(()=>{throw K},0)}})};return D(m,Wn.EventType.OPEN,()=>{R||(N(_e,`RPC '${e}' stream ${i} transport opened.`),C.__())}),D(m,Wn.EventType.CLOSE,()=>{R||(R=!0,N(_e,`RPC '${e}' stream ${i} transport closed`),C.u_())}),D(m,Wn.EventType.ERROR,P=>{R||(R=!0,fn(_e,`RPC '${e}' stream ${i} transport errored. Name:`,P.name,"Message:",P.message),C.u_(new L(k.UNAVAILABLE,"The operation could not be completed")))}),D(m,Wn.EventType.MESSAGE,P=>{var j;if(!R){const O=P.data[0];Q(!!O,16349);const V=O,K=(V==null?void 0:V.error)||((j=V[0])===null||j===void 0?void 0:j.error);if(K){N(_e,`RPC '${e}' stream ${i} received error:`,K);const ce=K.status;let X=function(_){const T=ie[_];if(T!==void 0)return Kh(T)}(ce),E=K.message;X===void 0&&(X=k.INTERNAL,E="Unknown error status: "+ce+" with message "+K.message),R=!0,C.u_(new L(X,E)),m.close()}else N(_e,`RPC '${e}' stream ${i} received:`,O),C.c_(O)}}),D(c,dh.STAT_EVENT,P=>{P.stat===zs.PROXY?N(_e,`RPC '${e}' stream ${i} detected buffering proxy`):P.stat===zs.NOPROXY&&N(_e,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{C.a_()},0),C}}function ks(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eE{}class tE extends eE{constructor(e,t,r,i){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=r,this.serializer=i,this.na=!1}ra(){if(this.na)throw new L(k.FAILED_PRECONDITION,"The client has already been terminated.")}zo(e,t,r,i){return this.ra(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,a])=>this.connection.zo(e,Zs(t,r),i,s,a)).catch(s=>{throw s.name==="FirebaseError"?(s.code===k.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),s):new L(k.UNKNOWN,s.toString())})}Yo(e,t,r,i,s){return this.ra(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([a,c])=>this.connection.Yo(e,Zs(t,r),i,a,c,s)).catch(a=>{throw a.name==="FirebaseError"?(a.code===k.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),a):new L(k.UNKNOWN,a.toString())})}terminate(){this.na=!0,this.connection.terminate()}}class nE{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.ia=0,this.sa=null,this.oa=!0}_a(){this.ia===0&&(this.aa("Unknown"),this.sa=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.sa=null,this.ua("Backend didn't respond within 10 seconds."),this.aa("Offline"),Promise.resolve())))}ca(e){this.state==="Online"?this.aa("Unknown"):(this.ia++,this.ia>=1&&(this.la(),this.ua(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.aa("Offline")))}set(e){this.la(),this.ia=0,e==="Online"&&(this.oa=!1),this.aa(e)}aa(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}ua(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new vn(fe.fromBase64String(e))}catch(t){throw new L(k.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new vn(fe.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ta{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new L(k.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new de(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class na{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new L(k.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new L(k.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return q(this._lat,e._lat)||q(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function uw(n){n=hr(n,Ne);const e=hr(n.firestore,ea);return zE(Sd(e),n._key).then(t=>pw(e,n,t))}class hw extends ow{constructor(e){super(),this.firestore=e}convertBytes(e){return new vn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Ne(this.firestore,null,t)}}function dw(n,e,t){n=hr(n,Ne);const r=hr(n.firestore,ea),i=aw(n.converter,e,t);return fw(r,[tw(ew(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,tt.none())])}function fw(n,e){return function(r,i){const s=new Et;return r.asyncQueue.enqueueAndForget(async()=>DE(await qE(r),i,s)),s.promise}(Sd(n),e)}function pw(n,e,t){const r=t.docs.get(e._key),i=new hw(n);return new Ud(n,i,e._key,r,new cw(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){(function(i){In=i})(Tn),We(new Me("firestore",(r,{instanceIdentifier:i,options:s})=>{const a=r.getProvider("app").getImmediate(),c=new ea(new J_(r.getProvider("auth-internal")),new ev(a,r.getProvider("app-check-internal")),function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new L(k.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ar(d.options.projectId,p)}(a,i),a);return s=Object.assign({useFetchStreams:t},s),c._setSettings(s),c},"PUBLIC").setMultipleInstances(!0)),xe(Kc,Qc,e),xe(Kc,Qc,"esm2017")})();const mw={apiKey:"AIzaSyCOrGrejZ1wWDnmUjGF62pYHYddJ4DGUXE",authDomain:"ethicalbadgeapp.firebaseapp.com",projectId:"ethicalbadgeapp",storageBucket:"ethicalbadgeapp.firebasestorage.app",messagingSenderId:"73453178206",appId:"1:73453178206:web:c5e32acdf519899cb493cf",measurementId:"G-04NG6ESJNV"},sa=iu(mw);Rg(sa);const ao=W_(sa),Fd=QE(sa),Bd="1:73453178206:web:c5e32acdf519899cb493cf";let ne={name:"Officer",email:null,uid:null,tcolePID:"123456",currentUnit:{start:"Sept 1, 2023",end:"Aug 31, 2025",requiredHours:40},completedHours:0,manuallyLoggedTrainings:[]};function Ge(){return{...ne}}function Ri(n){ne={...ne,...n}}async function gw(n,e){if(!e){console.warn("loadUserDataFromFirestore: No userId provided.");return}const t=Cd(n,`artifacts/${Bd}/users/${e}/profile`,"data");try{const r=await uw(t);if(r.exists()){const i=r.data();ne.name=i.name||ne.name,ne.email=i.email||ne.email,ne.tcolePID=i.tcolePID||ne.tcolePID,ne.manuallyLoggedTrainings=i.manuallyLoggedTrainings||[],ne.currentUnit=i.currentUnit||ne.currentUnit,ne.completedHours=0,ne.manuallyLoggedTrainings.forEach(s=>{typeof s.hours=="number"&&(ne.completedHours+=s.hours)}),console.log("User data loaded from Firestore into officerDataStore:",ne)}else console.log("No user profile data found in Firestore for UID:",e,". Using defaults or creating new.")}catch(r){console.error("Error loading user data from Firestore:",r)}}async function yw(n,e,t){if(!e){console.warn("saveUserDataToFirestore: No userId provided.");return}const r=Cd(n,`artifacts/${Bd}/users/${e}/profile`,"data");try{await dw(r,t,{merge:!0}),console.log("User data saved to Firestore for UID:",e),ne={...ne,...t},t.manuallyLoggedTrainings&&(ne.completedHours=0,ne.manuallyLoggedTrainings.forEach(i=>{typeof i.hours=="number"&&(ne.completedHours+=i.hours)}))}catch(i){console.error("Error saving user data to Firestore:",i)}}function ve(n){return n.replace(/[&<>'"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[e])}function _w(n){const e=document.getElementById(n);e&&(e.classList.remove("modal-inactive"),e.classList.add("modal-active"))}function Wr(n){const e=document.getElementById(n);e&&(e.classList.remove("modal-active"),e.classList.add("modal-inactive"))}function oa(n){if(!n)return;n.disabled=!0;let e=n.querySelector(".loading-spinner");e||(e=document.createElement("span"),e.className="loading-spinner ml-2",e.innerHTML='<svg class="animate-spin h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z"></path></svg>',n.appendChild(e)),e.style.display="inline-block"}function aa(n){if(!n)return;n.disabled=!1;const e=n.querySelector(".loading-spinner");e&&(e.style.display="none")}function Wi(){document.querySelectorAll(".expandable-card").forEach(n=>{const e=n.querySelector("button"),t=n.querySelector(".expandable-content");e&&t&&e.addEventListener("click",()=>{const r=e.getAttribute("aria-expanded")==="true";e.setAttribute("aria-expanded",!r),t.classList.toggle("card-collapsed"),t.classList.toggle("card-expanded")})})}let xs=null;function vw(n,e,t,r,i){const s=document.getElementById("officerNamePlaceholder"),a=document.getElementById("tcoleUnitDates"),c=document.getElementById("completedHours"),u=document.getElementById("requiredHours"),d=document.getElementById("legalUpdatesFeed"),p=document.getElementById("dilemmaOfTheWeekText"),m=document.getElementById("dilemmaOptions"),v=document.getElementById("analyzeDilemmaButton"),R=document.getElementById("dilemmaAiAnalysisContainer"),C=document.getElementById("dilemmaAiAnalysisContent");document.getElementById("dilemmaAiLoading");const D=document.getElementById("tcoleProgressChart");s&&(s.textContent=ve(n.name)),a&&(a.textContent=`${ve(n.currentUnit.start)} - ${ve(n.currentUnit.end)}`),Tw(n,D,c,u),d&&(d.innerHTML="",e.slice(0,4).forEach(P=>{const j=`
            ...
            <div class="p-4 border border-slate-200 rounded-lg bg-slate-50">
                ...
                </div>`;i.innerHTML+=D})),s&&a&&c&&u&&m&&(s.innerHTML="",e.forEach(C=>{const D=`
                ...
                <div id="${m.id.toLowerCase().replace(/\s+/g,"-")}" class="expandable-card border border-slate-300 rounded-xl shadow-sm overflow-hidden">
                    <button class="w-full text-left p-4 sm:p-5 bg-slate-100 hover:bg-slate-200 focus-visible:bg-slate-200 rounded-t-xl focus:outline-none flex justify-between items-center transition-colors duration-200" aria-expanded="false" aria-controls="${v}">
                        <span class="font-semibold text-blue-700">${r(m.title)} <span class="text-xs text-slate-500">(${r(m.category)})</span></span>
                        <span class="arrow-icon text-blue-700 text-2xl transform" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5"><path fill-rule="evenodd" d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" /></svg>
                        </span>
                    </button>
                    <div id="${v}" class="expandable-content px-4 sm:px-5 border-t border-slate-300 card-collapsed text-slate-700 bg-white rounded-b-xl">
                        <div class="py-4 text-sm sm:text-base leading-relaxed prose prose-sm sm:prose-base max-w-none">${m.content}</div>
                    </div>
